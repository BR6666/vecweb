...
!function (t, e) {
    ...
    var e = function (t) {
        var e = "ControlSidebar", i = "lte.controlsidebar", n = t.fn[e],
            ...
            l = ".main-header", d = ".main-footer", c = "control-sidebar-animate", h = "control-sidebar-open",
            ...
            b = "layout-md-footer-fixed", D = "layout-lg-footer-fixed", E = "layout-xl-footer-fixed",
            w = {controlsidebarSlide: !0, scrollbarTheme: "os-theme-light", scrollbarAutoHide: "l"}, A = function () {
                function e(t, e) {
                ...
                return n.collapse = function () {
                    ...
                    var e = t(window).height(), i = t(l).outerHeight(), n = t(d).outerHeight();
                    ...
                    return this.each((function () {
                        var s = t(this).data(i), o = t.extend({}, w, t(this).data());
        ...
        var e = "Layout", i = t.fn[e], n = ".main-header", s = ".main-sidebar", o = ".main-sidebar .sidebar",
            ...
            d = ".main-footer", c = '[data-widget="pushmenu"]', h = ".login-box", f = ".register-box",
            u = "sidebar-focused", g = "layout-fixed", p = "login-page", _ = "register-page",
            m = "control-sidebar-slide-open", C = "control-sidebar-open",
            v = {scrollbarTheme: "os-theme-light", scrollbarAutoHide: "l"}, y = function () {
                function e(t, e) {
                ...
                return i.fixLayoutHeight = function (e) {
                    ...
                    return void 0 === i && (i = ""), this.each((function () {
                        var n = t(this).data("lte.layout"), s = t.extend({}, v, t(this).data());
        ...
        var e = "PushMenu", i = ".lte.pushmenu", n = t.fn[e], s = {COLLAPSED: "collapsed" + i, SHOWN: "shown" + i},
            o = {autoCollapseSize: 992, enableRemember: !1, noTransitionAfterReload: !0}, a = {
                ...
                WRAPPER: ".wrapper"
            }, r = "sidebar-collapse", l = "sidebar-open", d = function () {
                function e(e, i) {
            ...
            d = "sidebar-collapse", c = {
                ...
                return i.init = function () {
                    ...
                    if (this._config.accordion) {
                        var d = i.siblings(a).first(), c = d.find(o).first();
                        this.collapse(c, d)
                    }
        ...
        var e = "Toasts", i = t.fn[e],
            ...
            r = "#toastsContainerBottomLeft", l = "toasts-top-right", d = "toasts-top-left", c = "toasts-bottom-right",
